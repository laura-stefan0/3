        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Smart course planning can significantly reduce your total degree cost and graduation time
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-bold mb-4">
              💡 Student-Recommended Strategy
            </h3>
            <p className="text-lg mb-4 opacity-90">
              Take General Education and Elective courses at Sophia since they're not major-specific anyway
            </p>
            <p className="text-base opacity-80">
              Focus your time and money on major courses at UoPeople while completing requirements efficiently through Sophia
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Make your degree more affordable and complete it faster
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Focus on Your Major</h3>
              <p className="text-gray-600">
                Complete non-major requirements efficiently, spend quality time on Computer Science courses
              </p>
            </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          >
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready to Plan Your Degree?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Start creating your personalized course plan and discover how much you can save
            </p>
            <Button 
              onClick={handleStartPlanning}
