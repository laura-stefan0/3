...
const categories = [
  { id: 'foundations', name: 'Mandatory Foundation & Communication', description: 'These mandatory UoPeople courses are automatically assigned to all new students.', maxSelections: 2, readonly: true },
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                    <div className="flex items-center">
                      ...
                      <p className="text-orange-800 font-medium">
                        Mandatory UoPeople Courses - These courses must be completed at UoPeople and cannot be exchanged with Sophia courses.
                      </p>
                    </div>
                  </div>
